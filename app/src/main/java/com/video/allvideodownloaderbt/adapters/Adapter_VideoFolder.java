...
//                                        context.startActivity(mVideoWatch);
                                        ...
                                        context.startActivity(new Intent(context, PlayActivity.class).putExtra("videourl", video.getStr_path()).putExtra(AppMeasurementSdk.ConditionalUserProperty.NAME, video.getId()));
