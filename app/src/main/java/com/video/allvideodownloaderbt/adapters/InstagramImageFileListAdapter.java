...
import com.video.allvideodownloaderbt.FullImageActivity;
import com.video.allvideodownloaderbt.PlayActivity;
...
//                                        context.startActivity(mVideoWatch);
                                    ...
                                    context.startActivity(new Intent(context, PlayActivity.class).putExtra("videourl", fileItem.getAbsolutePath()).putExtra(AppMeasurementSdk.ConditionalUserProperty.NAME, fileItem.getName()));
